...
public class ChannelCreator {
    ...
    public void createNotificationChannel(final CallbackContext callbackContext, final CordovaArgs args) {
        ...
        try {
            ...
            ChannelCreator.ChannelConfig channelConfig = new ChannelCreator.ChannelConfig(args.getJSONObject(0));
